                ...
                {announcements.length === 0 ? (
                  ...
                  announcements.map(ann => (
                    <div key={ann._id} className="notification-item" style={{borderLeft: '4px solid #ef4444', backgroundColor: 'rgba(31, 41, 55, 0.5)', padding: '12px', marginBottom: '10px', borderRadius: '8px'}}>
                      ...
                      <p className="notification-content custom-scrollbar" style={{maxHeight: '100px', overflowY: 'auto', overflowX: 'hidden', paddingRight: '5px', display: 'block', wordBreak: 'break-word', overflowWrap: 'anywhere', width: '100%'}}>{ann.content}</p>
