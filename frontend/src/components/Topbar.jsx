              ...
              <div className="notification-body">
                {announcements.length === 0 ? (
                  ...
                  announcements.map(ann => (
                    <div key={ann._id} className="notification-item" style={{borderLeft: '4px solid #ef4444'}}>
                      ...
                      <p className="notification-content" style={{maxHeight: '100px', overflowY: 'auto', paddingRight: '5px', scrollbarWidth: 'thin'}}>{ann.content}</p>
